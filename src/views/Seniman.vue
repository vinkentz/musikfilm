    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(i, index) in show_data_seniman" :key="index">
            <td>
              <span v-if="i.peran.value != 'Pengarang Musik'">
              ...
              <span v-else>
                <router-link to="/detailsPengarangMusik">
                  <span v-if="i.linkdata">
                    <a @click="detailsPengarangMusik(i.subject.value); dbpediaLink(i.linkdata.value)">{{i.label.value}}</a>
                  </span>
                  <span v-else>
                    <a @click="detailsPengarangMusik(i.subject.value)">{{i.label.value}}</a>
                  </span>
                </router-link>
              </span>
            </td>
...
export default {
  mounted() {
    ...
    this.$store.dispatch('detailsPengarangMusik')
